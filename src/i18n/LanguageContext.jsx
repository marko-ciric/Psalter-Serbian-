...
const T = {
  sr: {
    ...
    footerLine1: 'Превод: Ђуро Даничић (XIX век)',
    footerLine2: 'Са грчког (Седамдесеторица), по православној нумерацији.',
    footerLine3: 'Јавно власништво (public domain)',
    alleluia: 'Алилуја.',
    back: 'Назад',
    ...
    noFullText2: 'За сада је доступан почетни стих по преводу Ђуре Даничића.',
