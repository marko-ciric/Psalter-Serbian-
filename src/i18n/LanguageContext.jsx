...
const T = {
  ...
  en: {
    ...
    footerLine1: 'Translation: King James Version',
    footerLine2: 'From Hebrew and Greek.',
    ...
    noFullText2: 'Currently showing the opening verse from the King James Version.',
